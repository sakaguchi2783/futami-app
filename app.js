...
const FEMALE_Q = [
  ...
  { id:'F04', q:'診断やお悩み相談をした場合、結果はどの方法で受け取るのが便利ですか？',
...
async function renderMap(root){
  ...
  const markers = [
    ...
    {block:'9',  top:82, left:15},
    {block:'10', top:76, left:21},
    {block:'11', top:83, left:21},
    {block:'12', top:61.8, left:32},
    {block:'13', top:68.5, left:32},
    {block:'14', top:76, left:29},
    {block:'15', top:83, left:33},
    {block:'16', top:72, left:43.5},
    {block:'17', top:40, left:52},
    {block:'18', top:40, left:57},
    {block:'19', top:40, left:64},
    {block:'20', top:40, left:74},
    {block:'21', top:40, left:83},
    {block:'22', top:40, left:90},
    {block:'23', top:51, left:52.5},
    {block:'24', top:51, left:52.5},
    {block:'25', top:62, left:52.5},
    {block:'26', top:53, left:57.5},
    {block:'27', top:63, left:57.5},
    {block:'28', top:51, left:63},
    {block:'35', top:61, left:69.5},
  ];
